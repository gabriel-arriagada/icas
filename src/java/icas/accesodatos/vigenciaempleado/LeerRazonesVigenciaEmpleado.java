 ...
 * @author Gabriel
 */
public class LeerRazonesVigenciaEmpleado extends Leer {
    ...
    public LeerRazonesVigenciaEmpleado(Conexion conexion, boolean razonesPositivas){        
    ...
    public JSONArray leer() {
        ...
        try {
            if (this.conexion.abrirConexion()) {
                String consulta = "SELECT idRazon, razon FROM razonVigenciaEmpleado "
            ...
            Logger.getLogger(LeerRazonesVigenciaEmpleado.class.getName()).log(Level.SEVERE, null, ex);
