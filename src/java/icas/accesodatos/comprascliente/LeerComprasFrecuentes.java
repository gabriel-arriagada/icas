 ...
 * @author Gabriel
 */
public class LeerComprasFrecuentes extends Leer{

    private PreparedStatement preparedStatement;
    private ResultSet resultSet;  
    private final String rutCliente;
    
    public LeerComprasFrecuentes(Conexion conexion, String rutCliente)
    {
    ...
    public JSONArray leer() {
        JSONArray comprasFrecuentes = new JSONArray();                
        try {
            if (this.conexion.abrirConexion()) {

                String consultaCompras = "SELECT res_idVenta, res_idFormaPago, res_total FROM "
                        + "getComprasFrecuentes(?)";
                ...
                while (resultSet.next()) {
                    ...
                    int idVenta = resultSet.getInt("res_idVenta");
                    infoCompra.put("idFormaPago", resultSet.getInt("res_idFormaPago"));
                    infoCompra.put("total", resultSet.getInt("res_total"));
                    ...
                    comprasFrecuentes.add(compraMasDetalle);
                }
            }
