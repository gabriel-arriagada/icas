 ...
 * @author Gabriel
 */
public class LeerRazonesAutoVenta extends Leer {
    ...
    public LeerRazonesAutoVenta(Conexion conexion, boolean razonesPositivas){        
    ...
    public JSONArray leer() {
        ...
        try {
            if (this.conexion.abrirConexion()) {
                String consulta = "SELECT idRazon, razon FROM razonAutoVenta "
            ...
            Logger.getLogger(LeerRazonesAutoVenta.class.getName()).log(Level.SEVERE, null, ex);
