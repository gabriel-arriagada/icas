 ...
 * @author Gabriel
 */
public class CambiarClaveEmpleado extends Operacion{
    ...
    public CambiarClaveEmpleado(Conexion conexion, String rut, String clave) {
    ...
    public boolean ejecutar() {
        ...
        try {
            ...
            Logger.getLogger(CambiarClaveEmpleado.class.getName()).log(Level.SEVERE, null, ex);
            throw new RuntimeException(ex.getMessage());
        }
        
        String consulta = "UPDATE empleado SET clave = ? WHERE rut = ?";                
        ...
        if (this.conexion.abrirConexion()) {
            try {
                ...
                try {
                    ...
                    Logger.getLogger(CambiarClaveEmpleado.class.getName()).log(Level.SEVERE, null, ex1);
                    throw new RuntimeException(ex.getMessage());
                }
            } finally {
                try {
