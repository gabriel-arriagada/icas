 ...
 * @author Gabriel
 */
public class EditarUrlImagen extends Operacion{

    private PreparedStatement preparedStatement;
    private final Producto producto;

    public EditarUrlImagen(Conexion conexion, Producto producto) {
    ...
    public boolean ejecutar() {
        ...
        String consulta = "UPDATE producto SET urlImagen = ? WHERE idProducto = ?";
        ...
        if (this.conexion.abrirConexion()) {
            try {
                ...
                preparedStatement.setString(1, producto.getUrlImagen());
