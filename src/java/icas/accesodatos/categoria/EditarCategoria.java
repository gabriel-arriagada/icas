 ...
 * @author Gabriel
 */
public class EditarCategoria extends Operacion{

    private PreparedStatement preparedStatement;   
    private final Categoria categoria;
    
    public EditarCategoria(Conexion conexion, Categoria categoria) {
        ...
        if (this.conexion.abrirConexion()) {
            try {
                ...
                try {
                    ...
                    Logger.getLogger(EditarCategoria.class.getName()).log(Level.SEVERE, null, ex1);
