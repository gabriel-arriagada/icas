 ...
 * @author gabo
 */
@WebServlet(name = "ClienteComprasSaldoServlet", urlPatterns = {"/ClienteComprasSaldoServlet"})
public class ClienteComprasSaldoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (esChrome) {
            ...
            if (verificarSesion.verificarSesion(request, RolActual.ROL_CLIENTE) == true) {
                dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/vistas/cliente-compras-saldo.jsp");
